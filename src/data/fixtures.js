...
export const DATA = [
 {g:"A", teams:{MEX:"Mexico", RSA:"South Africa", KOR:"South Korea", CZE:"Czechia"}, matches:[
   ...
   {md:"Jun 24", h:"CZE", a:"MEX", score:[0,3], t:"8:00", v:"Mexico City"},
   {md:"Jun 24", h:"RSA", a:"KOR", score:[1,0], t:"8:00", v:"Guadalajara"},
 ]},
 {g:"B", teams:{CAN:"Canada", BIH:"Bosnia & Herz.", QAT:"Qatar", SUI:"Switzerland"}, matches:[
   ...
   {md:"Jun 24", h:"SUI", a:"CAN", score:[2,1], t:"2:00", v:"Vancouver"},
   {md:"Jun 24", h:"BIH", a:"QAT", score:[3,1], t:"2:00", v:"Seattle"},
 ]},
 {g:"C", teams:{BRA:"Brazil", MAR:"Morocco", HAI:"Haiti", SCO:"Scotland"}, matches:[
   ...
   {md:"Jun 24", h:"SCO", a:"BRA", score:[0,3], t:"5:00", v:"Miami"},
   {md:"Jun 24", h:"MAR", a:"HAI", score:[4,2], t:"5:00", v:"Atlanta"},
 ]},
 {g:"D", teams:{USA:"United States", PAR:"Paraguay", AUS:"Australia", TUR:"Türkiye"}, tag:"USA's group", matches:[
   ...
   {md:"Jun 25", h:"TUR", a:"USA", score:[3,2], t:"9:00", v:"Los Angeles"},
   {md:"Jun 25", h:"PAR", a:"AUS", score:[0,0], t:"9:00", v:"Santa Clara"},
 ]},
 {g:"E", teams:{GER:"Germany", CUW:"Curaçao", CIV:"Ivory Coast", ECU:"Ecuador"}, kcNote:"1× in KC", matches:[
   ...
   {md:"Jun 25", h:"ECU", a:"GER", score:[2,1], t:"3:00", v:"East Rutherford"},
   {md:"Jun 25", h:"CUW", a:"CIV", score:[0,2], t:"3:00", v:"Philadelphia"},
 ]},
 {g:"F", teams:{NED:"Netherlands", JPN:"Japan", SWE:"Sweden", TUN:"Tunisia"}, kcNote:"1× in KC", matches:[
   ...
   {md:"Jun 25", h:"JPN", a:"SWE", score:[1,1], t:"6:00", v:"Arlington"},
   {md:"Jun 25", h:"TUN", a:"NED", score:[1,3], kc:true, t:"6:00", v:"Kansas City"},
 ]},
 {g:"G", teams:{BEL:"Belgium", EGY:"Egypt", IRN:"Iran", NZL:"New Zealand"}, matches:[
   ...
   {md:"Jun 26", h:"EGY", a:"IRN", score:[1,1], t:"10:00", v:"Seattle"},
   {md:"Jun 26", h:"NZL", a:"BEL", score:[1,5], t:"10:00", v:"Vancouver"},
 ]},
 {g:"H", teams:{ESP:"Spain", CPV:"Cabo Verde", KSA:"Saudi Arabia", URU:"Uruguay"}, matches:[
   ...
   {md:"Jun 26", h:"CPV", a:"KSA", score:[0,0], t:"7:00", v:"Houston"},
   {md:"Jun 26", h:"URU", a:"ESP", score:[0,1], t:"7:00", v:"Guadalajara"},
 ]},
 {g:"I", teams:{FRA:"France", SEN:"Senegal", IRQ:"Iraq", NOR:"Norway"}, matches:[
   ...
   {md:"Jun 26", h:"NOR", a:"FRA", score:[1,4], t:"2:00", v:"Foxborough"},
   {md:"Jun 26", h:"SEN", a:"IRQ", score:[5,0], t:"2:00", v:"Toronto"},
 ]},
 {g:"J", teams:{ARG:"Argentina", ALG:"Algeria", AUT:"Austria", JOR:"Jordan"}, kcNote:"2× in KC", matches:[
   ...
   {md:"Jun 22", h:"JOR", a:"ALG", score:[1,2], t:"10:00", v:"Santa Clara"},
   {md:"Jun 27", h:"ALG", a:"AUT", score:[3,3], kc:true, t:"9:00", v:"Kansas City"},
   {md:"Jun 27", h:"JOR", a:"ARG", score:[1,3], t:"9:00", v:"Arlington"},
 ]},
 {g:"K", teams:{POR:"Portugal", COD:"DR Congo", UZB:"Uzbekistan", COL:"Colombia"}, matches:[
   {md:"Jun 17", h:"POR", a:"COD", score:[1,1], t:"12:00", v:"Houston"},
   {md:"Jun 17", h:"UZB", a:"COL", score:[1,3], t:"8:00", v:"Mexico City"},
   {md:"Jun 23", h:"POR", a:"UZB", score:[5,0], t:"12:00", v:"Houston"},
   {md:"Jun 23", h:"COL", a:"COD", score:[1,0], t:"9:00", v:"Guadalajara"},
   {md:"Jun 27", h:"COL", a:"POR", score:[0,0], t:"6:30", v:"Miami"},
   {md:"Jun 27", h:"COD", a:"UZB", score:[3,1], t:"6:30", v:"Atlanta"},
 ]},
 {g:"L", teams:{ENG:"England", CRO:"Croatia", GHA:"Ghana", PAN:"Panama"}, tag:"England's group", matches:[
   ...
   {md:"Jun 27", h:"PAN", a:"ENG", score:[0,2], t:"4:00", v:"East Rutherford"},
   {md:"Jun 27", h:"CRO", a:"GHA", score:[2,1], t:"4:00", v:"Philadelphia"},
 ]},
];
